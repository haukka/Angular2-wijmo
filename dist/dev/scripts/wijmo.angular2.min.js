/*
    ...
    *
    */
System.register("wijmo/wijmo.metaFactory", [], function(exports_1)
{
var wj;
return {
...
return this.getMetaData(wijmo.Control).add([this.CreateProp('owner', PropertyType.String), this.CreateProp('showTrigger', PropertyType.Enum, '', wijmo.input.PopupTrigger), this.CreateProp('hideTrigger', PropertyType.Enum, '', wijmo.input.PopupTrigger), this.CreateProp('fadeIn', PropertyType.Boolean), this.CreateProp('fadeOut', PropertyType.Boolean), this.CreateProp('modal', PropertyType.Boolean), ], [this.CreateEvent('showing'), this.CreateEvent('shown'), this.CreateEvent('hiding'), this.CreateEvent('hidden'), ]);
case wijmo.input && wijmo.input.MultiSelect:
return this.getMetaData(wijmo.input.ComboBox).add([this.CreateProp('checkedMemberPath', PropertyType.String), this.CreateProp('maxHeaderItems', PropertyType.Number), this.CreateProp('headerFormat', PropertyType.String), this.CreateProp('headerFormatter', PropertyType.Function), ], [this.CreateEvent('checkedItemsChanged', !0)]);
...
return this.getMetaData(wijmo.Control).add([this.CreateProp('value', PropertyType.Number, 'valueChanged'), this.CreateProp('min', PropertyType.Number), this.CreateProp('max', PropertyType.Number), this.CreateProp('origin', PropertyType.Number), this.CreateProp('isReadOnly', PropertyType.Boolean), this.CreateProp('step', PropertyType.Number), this.CreateProp('format', PropertyType.String), this.CreateProp('thickness', PropertyType.Number), this.CreateProp('hasShadow', PropertyType.Boolean), this.CreateProp('isAnimated', PropertyType.Boolean), this.CreateProp('showText', PropertyType.Enum, '', wijmo.gauge.ShowText), this.CreateProp('showRanges', PropertyType.Boolean), this.CreateProp('thumbSize', PropertyType.Number)], [this.CreateEvent('valueChanged', !0)], [this.CreateComplexProp('ranges', !0), this.CreateComplexProp('pointer', !1, !1), this.CreateComplexProp('face', !1, !1)]).addOptions({ngModelProperty: 'value'});
...
System.register("wijmo/wijmo.angular2.metaFactory", ["wijmo/wijmo.metaFactory"], function(exports_1)
{
...
System.register("wijmo/wijmo.angular2.directiveBase", ['angular2/core', 'wijmo/wijmo.angular2.metaFactory'], function(exports_1)
{
var ng2,
wjNg2Meta,
WjComponent,
...
thisDirMeta,
ret;
metaId || (options.wjMetadataId = metaId = baseDirMeta ? baseDirMeta.wjMetadataId : baseType);
var filterProps=function(name)
{
return ['properties', 'events', 'bindings', 'viewBindings'].indexOf(name) < 0
},
metaData=wjNg2Meta.MetaFactory.getMetaData(metaId),
changeEventsMap=Ng2Utils.getChangeEventMap(metaData);
return baseDirMeta && Ng2Utils._copy(mergedOptions, baseDirMeta, !0, !1, filterProps), Ng2Utils._copy(mergedOptions, options), hasOwnMeta && (mergedOptions.inputs = (options.inputs || []).concat([WjDirectiveBehavior.parPropAttr]).concat(metaData.props.map(function(propDesc)
{
return propDesc.propertyName
})), mergedOptions.outputs = (options.outputs || []).concat(Ng2Utils.initEvents(target, changeEventsMap))), Ng2Utils._copy(mergedOptions, options.wjOverride, !0), options.templateUrl ? delete mergedOptions.template : options.template && delete mergedOptions.templateUrl, options.styleUrls ? delete mergedOptions.styles : options.styleUrls && delete mergedOptions.styles, target[Ng2Utils.directiveTypeDataProp] = new DirectiveTypeData(metaData, changeEventsMap, mergedOptions.wjParentDirectives, mergedOptions.wjSiblingDirectiveId), retNg = mergedOptions.wjIsDirective ? ng2.Directive(mergedOptions) : ng2.Component(mergedOptions), thisDirMeta = Ng2Utils.getAnnotation(retNg.annotations, ng2.DirectiveMetadata), thisDirMeta && Ng2Utils._copy(thisDirMeta, mergedOptions, !0, !1, function(name)
{
return name.indexOf('wj') === 0
}), ret = retNg(target, targetKey), new MethodProxy(target, 'ngOnInit', WjDirectiveBehavior.prototype.dirOnInit), new MethodProxy(target, 'ngOnDestroy', WjDirectiveBehavior.prototype.dirOnDestroy), new MethodProxy(target, 'ngOnChanges', WjDirectiveBehavior.prototype.dirOnChanges), ret
}
});
...
parentDirectives && (this.parentDirectives = [].concat(parentDirectives));
this.siblingId = siblingId || (++DirectiveTypeData._siblingIdCounter).toString()
}
return DirectiveTypeData.prototype.resolveForwardDeclarations = function()
{
this._fwdResolved || (this._fwdResolved = !0, WjDirectiveBehavior.resolveForwardDecl(this.parentDirectives))
...
return WjDirectiveBehavior.getHostElement = function(directive, ngHostElRef)
{
...
{
for (var curNode, viewRef=viewContainerRef.createEmbeddedView(templateRef, viewContainerRef.length), nodes=viewRef.rootNodes, rootEl=document.createElement('div'), _i=0; _i < nodes.length; _i++)
curNode = nodes[_i],
...
{
for (var curEventMap, changeProps, _a, curChangeProp, changeEvents=this.typeData.changeEventMap, directive=this.directive, _i=0; _i < changeEvents.length; _i++)
if (curEventMap = changeEvents[_i], changeProps = curEventMap.props, curEventMap.eventImpl && (directive[curEventMap.eventImpl] = new ng2.EventEmitter(!1)), changeProps && changeProps.length)
for (_a = 0; _a < changeProps.length; _a++)
curChangeProp = changeProps[_a],
directive[curChangeProp.evImpl] = new ng2.EventEmitter(!1)
}, WjDirectiveBehavior.prototype.subscribeToEvents = function()
{
for (var curEventMap, changeEvents=this.typeData.changeEventMap, _i=0; _i < changeEvents.length; _i++)
curEventMap = changeEvents[_i],
...
return !1;
for (parInj = WjDirectiveBehavior.getBehavior(parentDirective).injector, childInj = WjDirectiveBehavior.getBehavior(childDirective).injector, curInj = childInj.parent; curInj; curInj = curInj.parent)
if (parInj === curInj)
return !0;
return !1
...
{
for (var curBeh, curDir, _i, parType, curInj=injector.parent; curInj != null; curInj = curInj.parent)
if (curBeh = WjDirectiveBehavior.getBehavior(curInj), curBeh)
{
if (upToBehavior === curBeh)
return null;
if (curDir = curBeh.directive, curDir)
for (_i = 0; _i < directiveTypes.length; _i++)
if (parType = directiveTypes[_i], parType && curDir instanceof parType)
return curBeh
}
return null
}, WjDirectiveBehavior.BehaviourRefProp = 'wjBehaviour', WjDirectiveBehavior.parPropAttr = 'wjProperty', WjDirectiveBehavior.siblingDirIdAttr = 'wj-directive-id', WjDirectiveBehavior._pathBinding = new wijmo.Binding(''), WjDirectiveBehavior
}();
...
{
for (var curEventMap, changeProps, _a, curChangeProp, ret=[], _i=0; _i < changeEvents.length; _i++)
if (curEventMap = changeEvents[_i], changeProps = curEventMap.props, curEventMap.event && curEventMap.eventImpl && ret.push(curEventMap.eventImpl + ':' + curEventMap.event), changeProps && changeProps.length)
for (_a = 0; _a < changeProps.length; _a++)
curChangeProp = changeProps[_a],
...
{
return type && ng2.reflector.annotations(type)
...
if (curAnno = annotations[_i], curAnno instanceof annotationType)
return curAnno;
return null
...
System.register("wijmo/wijmo.angular2.core", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
...
{
var _this=this;
this._component !== value && (this._cmpRef && (this._cmpRef.dispose(), this._cmpRef = null), this._component = value, value && this._dcl.loadIntoLocation(value, this._elementRef, 'anchor').then(function(cmpRef)
{
...
propChange;
if (cmp && properties)
for (propNames = Object.getOwnPropertyNames(properties), _i = 0; _i < propNames.length; _i++)
pName = propNames[_i],
...
{
this._bindingContext !== value && (this._bindingContext = value, this._cmpRef && (this._cmpRef.instance.updateProperties(value), console.log('updateProperties')))
}, enumerable: !0, configurable: !0
}), WjHtmlLoader.prototype.ngOnInit = function()
{
this._createComponent()
}, WjHtmlLoader.prototype._createComponent = function()
{
var _this=this;
if (this._cmpRef && (this._cmpRef.dispose(), this._cmpRef = null), this.html)
{
var self_1=this,
...
{
this.updateProperties(bindingContext)
}
...
pName;
if (bindingContext)
for (propNames = Object.getOwnPropertyNames(bindingContext), _i = 0; _i < propNames.length; _i++)
pName = propNames[_i],
...
this._dcl.loadIntoLocation(wjDynamicCmp, this._elementRef, 'anchor').then(function(cmpRef)
{
_this._cmpRef = cmpRef
})
}
...
System.register("wijmo/wijmo.angular2.input", ['angular2/core', 'angular2/common', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
this.invalidate()
}, WjMenu.prototype._loadingItems = function(){}, WjMenu.prototype._fmtItem = function(s, e)
{
var itemEl,
contentRoot;
...
WjMenuItem = function()
{
function WjMenuItem(elRef, injector, viewContainerRef, appViewManager, domRenderer)
{
this.elRef = elRef;
...
}), __param(0, core_2.Inject(core_1.ElementRef)), __param(1, core_2.Inject(core_1.Injector)), __param(2, core_2.Inject(core_1.ViewContainerRef)), __param(3, core_2.Inject(core_1.AppViewManager)), __param(4, core_2.Inject(core_1.Renderer))], WjMenuItem)
}();
...
}), __param(0, core_2.Inject(core_1.ElementRef)), __param(1, core_2.Inject(core_1.Injector)), __param(2, core_2.Inject(core_1.ViewContainerRef)), __param(3, core_2.Inject(core_1.AppViewManager)), __param(4, core_2.Inject(core_1.Renderer))], WjMenuSeparator)
}(WjMenuItem);
...
System.register("wijmo/wijmo.angular2.grid", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
}), __param(0, core_3.Inject(core_2.ViewContainerRef)), __param(1, core_3.Inject(core_2.TemplateRef)), __param(1, core_3.Optional()), __param(2, core_3.Inject(core_2.ElementRef)), __param(3, core_3.Inject(core_3.Renderer)), __param(4, core_3.Inject(core_3.Injector))], WjFlexGridCellTemplate)
}();
...
var templateType,
self;
if (_super.call(this), this._lastApplyTimeStamp = 0, this._noApplyLag = !1, this._startingEditing = !1, this.grid = grid, !DirectiveCellFactory._templateTypes)
{
...
{
(e.range.col < 0 || !grid.columns[e.range.col][WjFlexGridCellTemplate._getTemplContextProp(CellTemplateType.CellEdit)]) && (self._editChar = null);
setTimeout(function()
{
self._noApplyLag = !1
}, 300)
...
inpSt,
inpFocusEh;
if (rowIndex < panelRows.length && panelRows[rowIndex].renderHeight < cellHeight - 1)
{
...
else if (isEdit && !wijmo.contains(cellContext.rootElement, document.activeElement) && (inputs = cellContext.rootElement.querySelectorAll('input'), inputs))
...
curName,
dropDowns;
if (grid.cellEditEnding.removeHandler(editEndingEH), document.activeElement && document.activeElement.dispatchEvent(self._evtBlur), cell.focus(), !e.cancel)
{
e.cancel = !0;
var cellVar=cellInfo.localVars,
newVal=cellVar.value,
bindNames=Object.getOwnPropertyNames(cellInfo.bindings);
for (panel.grid.setCellData(rowIndex, colIndex, newVal), _i = 0; _i < bindNames.length; _i++)
curName = bindNames[_i],
cellInfo.bindings[curName].setValue(cellVar, cellInfo.localVars.values[curName])
}
...
isUpdated || this._baseCf.updateCell(panel, rowIndex, colIndex, cell, rng)
...
if (valuePaths)
for (pathNames = Object.getOwnPropertyNames(valuePaths), _i = 0; _i < pathNames.length; _i++)
pName = pathNames[_i],
binding = new wijmo.Binding(valuePaths[pName]),
bindings[pName] = binding,
values[pName] = binding.getValue(cellCtx);
return viewRef.setLocal('cell', cellCtx), ret
}, DirectiveCellFactory
}(wijmo.grid.CellFactory);
WjTemplateCmp = function()
{
function WjTemplateCmp(elRef, injector, viewContainerRef, templateRef, templates)
{
this.viewContainerRef = viewContainerRef;
this.templateRef = templateRef;
this.templates = templates;
var tr=this.templates
}
return WjTemplateCmp.prototype.ngAfterContentInit = function()
{
var tr=this.templates,
cc=this.contentChildren
}, WjTemplateCmp.prototype.ngAfterViewInit = function()
{
var self=this,
vc=this.viewChildren,
tr=vc.first,
viewRef=this.viewContainerRef.createEmbeddedView(tr, 0),
bbb;
setTimeout(function()
{
var viewRef2=self.viewContainerRef.createEmbeddedView(tr, 0)
}, 0);
bbb = !0
}, __decorate([core_3.ContentChildren(core_2.TemplateRef)], WjTemplateCmp.prototype, "contentChildren", void 0), __decorate([core_3.ViewChildren(core_2.TemplateRef)], WjTemplateCmp.prototype, "viewChildren", void 0), __decorate([core_1.Component({
selector: 'wj-template-cmp', template: "<template>Hey: <ng-content></ng-content></template>"
}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_3.Injector)), __param(2, core_3.Inject(core_2.ViewContainerRef)), __param(3, core_3.Inject(core_2.TemplateRef)), __param(3, core_3.Optional()), __param(4, core_3.Query(core_2.TemplateRef))], WjTemplateCmp)
}();
exports_1("WjTemplateCmp", WjTemplateCmp)
}
}
});
System.register("wijmo/wijmo.angular2.grid.filter", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.grid'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return __extends(WjFlexGridFilter, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
System.register("wijmo/wijmo.angular2.grid.grouppanel", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.grid.detail", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.grid'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return viewRef.setLocal('row', row), viewRef.setLocal('col', col), viewRef.setLocal('item', row.dataItem), templRoot.parentElement.removeChild(templRoot), templRoot[WjFlexGridDetail._viewRefProp] = viewRef, templRoot
};
...
System.register("wijmo/wijmo.angular2.grid.sheet", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
{
var behavior=wijmo_angular2_directiveBase_1.WjDirectiveBehavior.attach(this, elRef, injector);
this._flexSheet = behavior.parentBehavior.directive;
_super.call(this, this._flexSheet)
}
...
System.register("wijmo/wijmo.angular2.chart", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
{
var behavior=wijmo_angular2_directiveBase_1.WjDirectiveBehavior.attach(this, elRef, injector),
parentCmp=behavior.parentBehavior.directive;
_super.call(this, parentCmp)
}
return __extends(WjFlexChartLegend, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
selector: 'wj-flex-pie-data-label', wjParentDirectives: [WjFlexPie], template: ""
...
return __extends(WjFlexChartLineMarker, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
System.register("wijmo/wijmo.angular2.chart.interaction", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return __extends(WjFlexChartRangeSelector, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
return __extends(WjFlexChartGestures, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
System.register("wijmo/wijmo.angular2.chart.animation", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return __extends(WjFlexChartAnimation, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
System.register("wijmo/wijmo.angular2.chart.analytics", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.chart.annotation", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return __extends(WjFlexChartAnnotationLayer, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({
...
System.register("wijmo/wijmo.angular2.chart.finance", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.chart.finance.analytics", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase', 'wijmo/wijmo.angular2.chart', 'wijmo/wijmo.angular2.chart.finance'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.gauge", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.olap", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
System.register("wijmo/wijmo.angular2.all", ['wijmo/wijmo.angular2.input', 'wijmo/wijmo.angular2.grid', 'wijmo/wijmo.angular2.chart', 'wijmo/wijmo.angular2.gauge', 'wijmo/wijmo.angular2.core'], function(exports_1)
{
var wjNg2Input,
wjNg2Grid,
wjNg2Chart,
